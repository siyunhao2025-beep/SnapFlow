...
const api = {
  ...
  getProviderAudit: async (_provider?: ProviderId) => [] as ProviderAuditEntry[],
  ...
  getWorkflowRecommendations: async () => [] as WorkflowRecommendation[],
  ...
  listSkillMarketplace: async () => [] as SkillMarketplaceItem[],
